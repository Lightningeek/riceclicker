...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.lumpTooltip=function()
		{
			...
			loc("You have %1.",'<span class="price lump">'+loc (LBeautify(Game.lumps) + " soy sauce droplets",LBeautify(Game.lumps))+'</span>')+
			'<div class="line"></div>'+
		...
		new Game.Object('Farm','farm|farms|harvested|[X] more acre|[X] more acres','Be honest, you know what this does.',3,2,{base:'farm',xV:8,yV:8,w:64,rows:2,x:0,y:16},500,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
